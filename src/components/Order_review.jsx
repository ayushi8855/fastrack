      ...
      <hr/>
          ...
          <Row>
             ...
             <h5 className='title'>{e.title}</h5> 
              <br/>
              <h5 style={{display:"flex"}}>${e.your_price}  <p style={{marginRight:"5px",marginLeft:"5px",color:"gray",textDecoration:"line-through"}}>${e.total_price}</p><p style={{color:"red"}}> {e.dis}</p></h5>  
              </Col>
          </Row>
          </Col>
          <Col ><h5 className='hfive'>{e.qty}</h5></Col>
          <Col>{e.your_price*e.qty}</Col>
